...
/**
 * description: 自定义序列化抽象类
 *
 * @author : jy.chen
 * @version : 1.0
 * @since : 2016-11-24 18:21
 */
public abstract class Serializer {

    public static final Charset CHARSET = Charset.forName("UTF-8");// 字符集

    protected ByteBuf           writeBuffer;                       // 写Buffer

    protected ByteBuf           readBuffer;                        // 读Buffer
